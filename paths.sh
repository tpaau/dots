...
CAVA_DST="config/cava"
CAVA_SRC="$HOME/.config/cava/config"

FASTFETCH_DST="config/fastfetch"
...
SCRIPTS_DST="config/shell-scripts"
SCRIPTS_SRC="$HOME/.config/tpaau-17DB-scripts/"

SHARE_DST="config/usr.share.tpaau-17DB-dots.wlogout"
SHARE_SRC="/usr/share/tpaau-17DB-dots/wlogout/"

WAYBAR_DST="config/waybar"
